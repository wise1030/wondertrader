...
bool FutuConfigLoader::load(wtp::WTSVariant* cfg, FutuMmConfig& _config,
                            std::vector<ContractInfo>& _contract_infos, const char* id)
{
    ...
    auto readString = [](wtp::WTSVariant* v, const char* k, const char* d) -> std::string { return FutuConfig::readString(v, k, d); };
...
WTSLogger::warn("UftFutuMmStrategy[{}] levelQtyMultiplier={} out of typical range [0.1, 1.0]", id, _config.quoting.level_qty_multiplier);
}
