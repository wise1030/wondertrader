...
struct AlphaResult
{
    ...
    AlphaResult() : alpha(0), confidence(0), ofi_component(0), trade_component(0), is_strong_signal(false), timestamp(0)
    {}
};
...
struct TradeImbalanceResult
{
    ...
    TradeImbalanceResult() : net_flow(0), imbalance_ratio(0), large_trade_ratio(0), timestamp(0) {}
};
