...
struct TradeRecord
{
    ...
    TradeRecord()
        : order_id(0), price(0), qty(0), mid_at_trade(0), spread_at_trade(0), is_buy(false), is_crossing(false),
...
struct PnLAttribution
{
    ...
    PnLAttribution() : spread_pnl(0), inventory_pnl(0), adverse_selection(0), alpha_pnl(0), timing_pnl(0) {}

    double total() const { return spread_pnl + inventory_pnl + alpha_pnl + timing_pnl - adverse_selection; }
};
...
struct PerformanceMetrics
{
    ...
    PerformanceMetrics()
        : total_pnl(0), unrealized_pnl(0), total_volume(0), total_trades(0), avg_spread_captured(0),
          spread_capture_rate(0), fill_rate(0), cross_rate(0), avg_fill_latency_us(0), max_drawdown(0), sharpe_ratio(0),
          sortino_ratio(0), win_rate(0), adverse_ratio(0), real_adverse_per_vol(0), toxicity_events(0),
          alpha_accuracy(0), alpha_pnl_per_trade(0), avg_inventory(0), inventory_turnover(0), max_inventory_held(0),
...
struct ConditionPerformance
{
    ...
    ConditionPerformance()
        : condition(MarketCondition::NORMAL), pnl(0), trade_count(0), volume(0), win_rate(0), avg_spread_captured(0)
    {}
};
...
struct AnalyzerConfig
{
    ...
    AnalyzerConfig() : strong_alpha_threshold(0.3) {}
};
...
inline const char* marketConditionName(MarketCondition cond)
{
    ...
    case MarketCondition::LOW_VOLATILITY:
        return "LOW_VOLATILITY";
    case MarketCondition::AUCTION:
        return "AUCTION";
    case MarketCondition::NEWS_EVENT:
        return "NEWS_EVENT";
